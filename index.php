   ...
   <body>
      ...
      <div class="page" id="page-additem">
         <div class="section purple white-text z-depth-3" style="padding: 1rem 0rem 1rem 0.8rem;z-index: 999">
            ...
            <i class="material-icons click" style="vertical-align: -8px;margin-right:5px;font-size: 2.5rem" id="but-home">navigate_before</i> Add Item to your order</h4>
         </div>
         <div class="container">
            <div class='section'>
      ...
      </div><script type="text/javascript" src="js/materialize.min.js"></script><script type="text/javascript" src="js/index.js"></script>
   </body>
</html>